...
content_id: 801bd76f3e2166e3b0ecfe48aac35294d35291aad160aa4e5538e6eb643e740a
---
...
Deno.test("Query: _getUserByUsername - Retrieve User ID by username", async () => {
  ...
  try {
    ...
    assertEquals(userResult[0].user, bobId, "Returned user ID should match registered user ID.");
