...
content_id: 1a8380c583242ae6a78ab4ff72c596cc6c2d755225a227588cf6718a102ac6f1
---
...
Deno.test("Action: modifyEvent - success and preconditions", async () => {
  ...
  try {
    ...
    assertEquals((noChangeResult as { error: string }).error, `Event with ID ${eventId} matched but no changes were applied.`, "Error message should reflect no actual changes.");
