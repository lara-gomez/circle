...
Deno.test("Principle: User declares and manages personal and item interests", async () => {
  ...
  try {
    ...
    const addTechResult = await userInterestConcept.addPersonalInterest({ user: userA, tag: techTag });
    ...
    const addTravelResult = await userInterestConcept.addPersonalInterest({ user: userA, tag: travelTag });
    ...
    const addItem1Result = await userInterestConcept.addItemInterest({ user: userA, item: item1 });
    ...
    const addItem2Result = await userInterestConcept.addItemInterest({ user: userA, item: item2 });
    ...
    const removeTechResult = await userInterestConcept.removePersonalInterest({ user: userA, tag: techTag });
    ...
    const removeItem1Result = await userInterestConcept.removeItemInterest({ user: userA, item: item1 });
...
Deno.test("Action: addPersonalInterest requirements", async () => {
  ...
  try {
    ...
    const addResult = await userInterestConcept.addPersonalInterest({ user: userA, tag });
    ...
    const duplicateResult = await userInterestConcept.addPersonalInterest({ user: userA, tag });
...
Deno.test("Action: removePersonalInterest requirements and effects", async () => {
  ...
  try {
    ...
    const interestsBefore = await userInterestConcept._getPersonalInterests({ user: userA });
    ...
    const nonExistentResult = await userInterestConcept.removePersonalInterest({ user: userA, tag: nonExistentTag });
    ...
    const removeResult = await userInterestConcept.removePersonalInterest({ user: userA, tag });
    ...
    const interestsAfter = await userInterestConcept._getPersonalInterests({ user: userA });
...
Deno.test("Action: addItemInterest requirements and effects", async () => {
  ...
  try {
    console.log("Test: Add successfully and check effects.");
    const addResult = await userInterestConcept.addItemInterest({ user: userB, item: item1 });
    ...
    const duplicateResult = await userInterestConcept.addItemInterest({ user: userB, item: item1 });
...
Deno.test("Action: removeItemInterest requirements and effects", async () => {
  ...
  try {
    ...
    const interestsBefore = await userInterestConcept._getItemInterests({ user: userB });
    ...
    const nonExistentResult = await userInterestConcept.removeItemInterest({ user: userB, item: item2 });
    ...
    const removeResult = await userInterestConcept.removeItemInterest({ user: userB, item: item1 });
    ...
    const interestsAfter = await userInterestConcept._getItemInterests({ user: userB });
